...
export const adminSteps: TourStep[] = [
  ...
  {
    tab: "accounts",
    target: "btn:Add an account",
    title: "1 · Add a login",
    body: "Sign a Claude account in here. The panel holds it — members never do. “Give access” on a card then lends it to someone.",
  },
  {
    tab: "people",
    target: "btn:Invite someone",
    title: "2 · Invite your people",
    body: "Send an invite link. They install clawdh, paste it, and they’re set up — no login ever leaves the gateway.",
  },
  {
    tab: "usage",
    target: "tab:Usage",
    title: "3 · Watch usage",
    body: "See who spent what, per person and per model — live.",
  },
  {
    tab: "quotas",
    target: "tab:Quotas",
    title: "4 · Set quotas",
    body: "Cap a person, one account, or the whole team. Over the cap, clawdh turns them away like a real spend limit.",
  },
  {
